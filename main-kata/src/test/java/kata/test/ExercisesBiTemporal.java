        ...
        extends AbstractMithraTest
{
    ...
    {
        return new String[]{"testdata/data_CustomersAccountsBalances.txt"}; // Look into this file to see the test data being used
    }
...
// You should also enrich the data in testdata/data_Exercise3.txt so that it can cover the functionality you wish to test.
